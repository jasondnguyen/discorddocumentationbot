...
class WebParser:
    ...
    def __init__(self):
        ...
        self.db = client.DocLookup

    def python_lookup(self):
        '''
        ...
        for link in link_lists.python_link_list:
            ...
            try:
                ...
                for dl in dls:
                    ...
                    result = self.db.Python.insert_one(python)
            except:
                pass

    def readable_pTag(self, textTag):
        '''
    ...
    def readable_preTag(self, textTag):
        '''
        Returns all the text formatted if
    ...
    def javascript_lookup(self):
        '''
        Parses all strong tags and info for the tags
        ...
        for link in link_lists.javascript_link_list:
            try:
                ...
                result = self.db.JavaScript.insert_one(javascript)
            except:
                pass
